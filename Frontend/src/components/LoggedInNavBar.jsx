        ...
        <div className="container px-4 mx-auto relative text-sm">
            <div className="flex justify-between items-center">
                <div className="flex items-center flex-shrink-0">
                    ...
                    <button onClick={toggleMode} id="togglemode" className="ml-10 rounded-2xl border-2 border-black bg-white p-1 font-semibold uppercase text-black transition-all duration-300 hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[4px_4px_0px_black] active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none">
                    </button>
                </div>
                ...
                <ul className="hidden lg:flex ml-32 space-x-12">
                    ...
                    <Link to="home" spy={true} smooth={true} duration={500} offset={-80} activeClass="text-orange-400">
