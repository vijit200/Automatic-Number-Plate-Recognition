...
from licensePlateDetection.entity.config_entity import DataIngestionConfig
from licensePlateDetection.entity.artifacts_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def download_data(self) -> str:
        ...
        try:
            ...
            data_file_name = "license_plate.zip"
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            data_ingestion_artifact = DataIngestionArtifact(
                ...
                feature_store_path=feature_store_path + "/license_plate"
            )
